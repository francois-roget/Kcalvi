// src/ui/theme/index.ts — tokens Kcalvi (design system validé)
export const colors = {
  ...
  border: { default: '#E9E3D8', subtle: '#F1EDE5', dashed: '#DCD5C8', onDark: '#264A5C', info: '#D3E5F0' },
  text: {
    primary: '#17303D', secondary: '#6E7C86', tertiary: '#8A9AA5',
    quaternary: '#A6B2BB', disabled: '#C0C9CF', accent: '#1C86C4',
  },
...
export const radius = { sm: 12, md: 14, lg: 16, xl: 18, '2xl': 20, '3xl': 24, '4xl': 28, pill: 999 } as const;
...
export const typography = {
  ...
  overline:{ fontFamily: 'Manrope_700Bold', fontSize: 11, letterSpacing: 1.2, textTransform: 'uppercase' as const },
  micro:   { fontFamily: 'Manrope_600SemiBold', fontSize: 10.5 },
} as const;

export const shadows = {
  card:   { shadowColor: '#17303D', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 1 },
  raised: { shadowColor: '#17303D', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 12, elevation: 2 },
  sheet:  { shadowColor: '#17303D', shadowOffset: { width: 0, height: -6 }, shadowOpacity: 0.16, shadowRadius: 24, elevation: 8 },
} as const;
...
export const lightTheme = { colors, spacing, radius, typography, shadows, layout } as const;
export type AppTheme = typeof lightTheme;
// Dark mode : la structure des tokens le permet (ink.* deviennent surfaces, sand.* deviennent textes).
// Non implémenté pour le MVP (TECHNICAL_SPECS §9.1, §20).
